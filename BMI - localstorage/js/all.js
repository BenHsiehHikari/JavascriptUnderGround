// 指定 DOM
const calresultP = document.getElementById("calresult");

const calresulttextP = document.getElementById("calresulttext");
...
const userbmilist = document.querySelector('.userbmilist');

const userBMIDataPool = JSON.parse(localStorage.getItem('userBMIData')) || [];


// 監聽與更新
calresultP.addEventListener('click', calresultBtnAction, false); //#endregion
...
function calresultBtnAction() {
    ...
    bmireset.addEventListener("click", function() {
        ...
        calresultP.className = "";
        calresultP.innerHTML = "看結果";
        document.querySelector('#calresulttext').innerHTML = "";
